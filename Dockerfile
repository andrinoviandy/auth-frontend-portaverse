...
ENV VITE_API_AUTH_SERVICE_URL=https://user-auth-service-dev.portaverse.co.id
ENV VITE_KMS_URL=https://kms-dev.portaverse.co.id
ENV VITE_LMS_URL=https://lms-dev.portaverse.co.id
ENV VITE_TMS_URL=https://tms-dev.portaverse.co.id
