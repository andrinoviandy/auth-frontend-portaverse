...
ENV VITE_API_AUTH_SERVICE_URL=https://user-auth-service-dev.ilcs.co.id
ENV VITE_KMS_URL=https://kms-dev.ilcs.co.id
ENV VITE_LMS_URL=https://lms-dev.ilcs.co.id
ENV VITE_TMS_URL=https://tms-dev.ilcs.co.id
