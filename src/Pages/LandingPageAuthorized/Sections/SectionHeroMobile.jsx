...
export default function SectionHeroMobile() {
  ...
  return (
    <section className="relative pb-10 mt-4">
      {/* Banner */}
      {bannerData?.hasYearlyReportBanner && (
        <div className="relative p-5 mx-2 bg-white border rounded-md">
          <img
            src={YearlyReportIllust}
            alt="illust"
            className="absolute bottom-0 right-0 h-[190px] z-0 rounded-r-md"
          />
          <div className="relative z-10 flex flex-col gap-1 space-y-2">
            <p className="text-lg font-bold font-tertiary">
      ...
      <div className="flex flex-col gap-8 px-4 py-4">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-8 p-6 border rounded-md">
            <ProfilePicture
