...
import EmailIcon from "../../Components/Assets/Icon/Email";
      ...
      <div className="w-[22rem] mt-7">
        ...
        <div className="flex items-center justify-center gap-2 my-3">
          {timer > 0 && fetchError.length === 0 ? (
            ...
            <>
              <h5 className="text-sm text-gray font-secondary">
        ...
        <Link
          to="/login"
          className="font-secondary font-medium text-gray hover:text-darkGray hover:bg-bg1 py-1 px-4 flex rounded items-center justify-center my-1.5"
        >
