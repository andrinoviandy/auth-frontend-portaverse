...
// timeout
axiosKmsClient.defaults.timeout = 5000;

// redirect when cookies expired
axiosKmsClient.interceptors.response.use(
  function (response) {
    return response;
  },
  function (error) {
